...
class Component(ComponentAbstract):
    ...
    def __init__(self, component_name="bwa_mem", component_parent_dir=None,
                 seed_dir=None):
        self.version = "1.0.0"
    ...
    def make_cmd(self, chunk=None):
        ...
        spec_args = ["output_bam"]
        spec_args_dict = {k: v for k, v in args_dict.items() if k in spec_args}
        for arg in spec_args:
            del args_dict[arg]

        # Extract positional arguments
        pos_args = ["bwa_index_prefix", "reads_fastq1", "reads_fastq2"]  # Order matters here
