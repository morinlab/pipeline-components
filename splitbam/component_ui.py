...
parser.add_argument("--output_file1",required=False,help="Optional filename for samtools view -f(samflag) output")
parser.add_argument("--output_file2",required=False,help="Optional filename for samtools view -F(samflag) output")
