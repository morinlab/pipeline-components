...
class Component(ComponentAbstract):
    ...
    def __init__(self, component_name="bamhash_checksum_fastq", component_parent_dir=None,
                 seed_dir=None):
        self.version = "1.1"
    ...
    def make_cmd(self, chunk=None):
        ...
        cmd = self.requirements["bamhash_checksum_fastq"]
        cmd_args = []
        ...
        pos_args = ["reads_fastq1", "reads_fastq2"]  # Order matters here
